...
## 📋 Descripción General
El sistema captura señales de audio del funcionamiento de maquinaria industrial utilizando microcontroladores **ESP32**. Esta información se procesa en un servidor central que utiliza modelos de Deep Learning para eliminar el ruido ambiental y diagnosticar el estado del equipo mediante su huella digital sonora.
...
graph TD  
    ...
    H -->|5. Señal Limpia| I[Filesystem: Audio Procesado]  
